...
<head>
    ...
    <link rel='stylesheet' href="./css/global_output_style.css">
...
<header>
    ...
    <div class="heroe">
        ...
        <h1 class='text-red-600 font-bold'>Welcome to CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2 class='text-indigo-800'>The small framework with powerful features</h2>
...
<section>
    ...
    <h1 class='text-amber-700 font-bold'>About this page</h1>
